...
import LinkedinAlt from 'packages/icons/src/monochrome/LinkedinAlt';
import Twitter from 'packages/icons/src/monochrome/Twitter';
import Skype from 'packages/icons/src/monochrome/Skype';

import Link from 'packages/common/src/components/Link';
...
Team.propTypes = {
   ...
   * @See packages/common/src/components/Grid
   */
  GridProps: PropTypes.object,
  /**
   * Props of button below grid
   * @See packages/common/src/components/Button
   */
